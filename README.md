...
Размер - 100 млн пользователей * 100000 * 0.5 (50 % писем с вложениями, из них большая часть с одним вложением) * 777 байт = 3,4 пб   
Количество строк - 5 000 000 000 000
#### Таблица file (Файлы)
| Поле              | Тип данных   | Размер (байты) |
|-------------------|--------------|----------------|
| id                | int          | 4              |
...
Размер - 100 млн пользователей * 100000 * 0.5 (50 % писем с вложениями, из них большая часть с одним вложением) * 0.75 (пусть 25 % используют один и тот же файл) * 1050 кб (средний вес вложения) = 3492 пб   
Количество строк - 3 750 000 000 000
