...
|-------------------|-----------------------|-----------|----------|
| Cassandra         | 689 чтение + 231 запись + 4166 запись = 5086. С учетом репликаций  - 1500 | 1600 ядер | 30 пб |
| S3 mail storage  | 115 запись + 2065 чтение. С учетом репликаций- 6200 | 100 ядер  | 45 пб    |
