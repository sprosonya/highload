...
|-------------------|-----------------------|-----------|----------|
| Cassandra         | 689 чтение + 231 запись + 4166 запись = 5086. С учетом репликаций и пиковых значений - 30600 | 3100 ядер | 30 пб |
| S3 mail storage  | 115 запись + 2065 чтение. С учетом репликаций и пиковых значений - 12600 | 500 ядер  | 45 пб    |
...
Из-за размера проекта, логичнее развертывать на собственном железе
| Название | Хостинг | Конфигурация | Cores | Cnt | Покупка | Аренда |
| -------- | ------- | ------------ | ----- | --- | ------- | ------ |
| kuberNode | own | 2x6338/16x32GB/2xNVMe4T/2x25Gb/s | 64 | 10 | 145000 ($14500) | 24100 $241 |
| cassandraNode | own | 2x6338/12x64GB/3xNVMe2T/1x100Gb | 48 | 5100 (30пб / 6тб) | 61000k$ (12000$) | 2550k 500$ |
| s3 node | own | 2x6338/12x64GB/3xNVMe2T/1x100Gb | 48 | 7700 (45пб / 8тб) | 92000k$ (12000$) | 3850k$ (500$) |
