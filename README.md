...
| ClickHouse      | Хранение аналитики     | Быстрое и дешевое хранение |
...
| Nginx L4        | 7500 | 15 000           | 30         | 30       | 1 ядро = ~500 CPS (Nginx) |
| Nginx L7        | 7500 | 15 000           | 30         | 30       | 1 ядро = ~500 RPS (Nginx + TLS) |
...
|-------------------|-----------------------|-----------|----------|
| Cassandra         | 689 + 231 + 4166       | 240 ядер  | 10 пб    |
| S3 mail storage  | 115 + 2065            | 180 ядер  | 15 пб    |
| PostgreSQL       | 295 + 578             | 64 ядра   | 200 тб   |
