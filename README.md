...
15) Средний вес письма 75 кб [^9]
16) Максимальный размер вложений 25 мб
17) > 100 млн зарегистрированных пользователей в 2018 [^10]
## Расчет нагрузки
| | Аудитория |
| 
| Запрос | RPS | Traffic | 
...
[^10]: [Новость](https://kod.ru/pochte-mailru-20-let?ysclid=m7j96i7a4o333811896)
